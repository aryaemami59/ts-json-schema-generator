 ...
 * {@linkcode AnnotatedNodeParser} to attach schema annotations
 * (descriptions, examples, defaults, etc.) to parsed types.
 *
...
export interface AnnotationsReader {
    /**
     * Reads JSDoc annotations from {@linkcode node} and returns them as an
     * {@linkcode Annotations} map, or `undefined` when no relevant annotations
     * are present.
     *
